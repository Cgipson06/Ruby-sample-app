...
class UsersEditTest < ActionDispatch::IntegrationTest
  ...
  test "successful edit" do 
    ...
    assert_template 'users/edit'
    name = "Foo Bar"
    email = "Poo@bar.com"  #assert_equal failed on uppercase password, added #.downcase below
  ...
  #end
##these are throwing invalid uri errors, i cant find a solution yet, i think it
##has to do with the '_' in the static_pages, and rspec
